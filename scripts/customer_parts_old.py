    ...
    def customer_parts_next_spq(cell_row, cell_col, new_mod):
        ...
        try:
            for row in range(9, selected['backup_3'].sheet_by_index(0).nrows):
                supplier_parts[selected['backup_3'].sheet_by_index(0).cell_value(row, 2) + selected['backup_3'].sheet_by_index(0).cell_value(row, 3)] = selected['backup_3'].sheet_by_index(0).cell_value(row, 8)

            for row in range(9, additional['TNM_SUPPLIER_PARTS_MASTER'].nrows):
                if additional['TNM_SUPPLIER_PARTS_MASTER'].cell_value(row, 9) != '':
                    ...
                    supplier_parts[str(additional['TNM_SUPPLIER_PARTS_MASTER'].cell_value(row, 2)) + additional['TNM_SUPPLIER_PARTS_MASTER'].cell_value(row, 3)] = additional['TNM_SUPPLIER_PARTS_MASTER'].cell_value(row, 8)
        ...
        try:
            ...
            if srbq % spq == 0 or spq % srbq == 0:
                if orderlot % srbq == 0:
                    print ('SPQ check --- Pass (OL: %d, SPQ: %d, SRBQ: %d)' % (orderlot, spq, srbq))
                    ...
                    print ('SPQ check --- Fail (OL: %d, SPQ: %d, SRBQ: %d)' % (orderlot, spq, srbq))
                ...
                try:
                    for row in range(9, additional['TNM_SUPPLIER_PARTS_MASTER'].nrows):
                        if additional['TNM_SUPPLIER_PARTS_MASTER'].cell_value(row, 0) == 'NEW' and additional['TNM_SUPPLIER_PARTS_MASTER'].cell_value(row, 2) == part_no:
                            supplier_part_exp_country.append((additional['TNM_SUPPLIER_PARTS_MASTER'].cell_value(row, 2), additional['TNM_SUPPLIER_PARTS_MASTER'].cell_value(row, 3), additional['TNM_SUPPLIER_PARTS_MASTER'].cell_value(row, 7)))
